...
import com.mininghat.bridge.exception.RemoteApiException;
import com.mininghat.bridge.model.CompanyApiResult;
...
@Service
public class CompanyApiGateway {

    private final CompanyApiProperties properties;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;

    public CompanyApiGateway(CompanyApiProperties properties, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    private CompanyApiResult exchange(
        ...
        try {
            ...
            throw new RemoteApiException("调用公司接口失败", ex);
